...
public class HashFunctionHashMapSerializer implements Serializer {
    ...
    public HashFunctionHashMapSerializer(String inputFile, String outputFile) {
    ...
    public HashFunctionHashMapSerializer(String inputFile, String outputFile, HashMap<String, HashMap<String, String>> loadFactorHashMap) {
        keyList = new ArrayList<>();
